...
#For BMI condition Analysis by using height and weight
#Height part
col1, col2 = st.sidebar.columns(2)
with col1:
    feet = st.number_input("What is your height? ft", min_value=1, max_value=8, step=1)
with col2:
    inch = st.number_input("in", min_value=0, max_value=9, step=1)
height = feet * 12 + inch
#Wight part
weight = st.sidebar.slider("What is your weight? lb?", max_value=1000) 
#Convert BMI based on height and weight. The formula is: weight (lb) / [height (in)]^ 2 x 703.
...
#For version5, I want to remove this feature. So I set everyone as "Inside a suburban county of the MSA"
metro = 3
...
with col1:
    ...
    if BMI == 1:
      st.write("Your BMI is " + str(BMI_val)[0 : 4])
      st.write("You are underweight")
    elif BMI == 2:
      st.write("Your BMI is " + str(BMI_val)[0 : 4])
      st.write("You are at normal weight range")
    elif BMI == 3:
      st.write("Your BMI is " + str(BMI_val)[0 : 4])
      st.write("You are overweighted")
    else: 
      st.write("Your BMI is " + str(BMI_val)[0 : 4])
...
with col2:
    ...
    st.write("The distribution of exercise")
